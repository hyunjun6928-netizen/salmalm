...
.. deprecated::
    ...
    ============================================================
    Old (via shim)              →  New (direct, preferred)
    ============================================================
    salmalm.core.engine         →  salmalm.core.intelligence_engine
    salmalm.core.engine.process_message
                                →  salmalm.core.engine_pipeline.process_message
    salmalm.core.engine.cost    →  salmalm.core.cost
    salmalm.core.engine.llm_*   →  salmalm.core.llm_loop / llm_router
    ============================================================

    The shim will be retained through the next major version to avoid
    breaking external consumers; track removal in GitHub issues.
