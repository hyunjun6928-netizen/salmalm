...
class HealthMonitor:
    ...
    def startup_selftest(self) -> dict:
        ...
        modules = [
            ...
            ("crypto", "salmalm.security.crypto"),
            ("core", "salmalm.core"),
            ("llm", "salmalm.core.llm"),
            ("tools", "salmalm.tools"),
            ("prompt", "salmalm.core.prompt"),
            ("engine", "salmalm.core.engine"),
            ("telegram", "salmalm.channels.telegram"),
            ("web", "salmalm.web.web"),
            ("ws", "salmalm.web.ws"),
            ("rag", "salmalm.features.rag"),
            ("mcp", "salmalm.features.mcp"),
            ("browser", "salmalm.tools.tools_browser"),
            ("nodes", "salmalm.features.nodes"),
            ("auth", "salmalm.web.auth"),
            ("tls", "salmalm.utils.tls"),
            ("agents", "salmalm.features.agents"),
            ("tool_handlers", "salmalm.tools.tool_handlers"),
            ("container", "salmalm.security.container"),
            ("discord_bot", "salmalm.channels.discord_bot"),
        ]
