"""Task classification and extra tool inference."""

from __future__ import annotations

from typing import Any, Dict, Optional

from salmalm.constants import INTENT_COMPLEX_MSG, INTENT_CONTEXT_DEPTH, INTENT_SHORT_MSG
...
def classify(message: str, context_len: int = 0) -> Dict[str, Any]:
    """Backward-compatible module-level classify helper."""
    return TaskClassifier.classify(message, context_len=context_len)
