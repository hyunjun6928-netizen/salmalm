"""Keyword and pattern datasets for task classification and tool injection."""
...
# Re-export model selection complexity heuristics for backward compatibility.
from salmalm.core.model_selection import _COMPLEX_KEYWORDS, _MODERATE_KEYWORDS, _SIMPLE_PATTERNS
