"""Patch engine.py to add slash command handlers."""
import sys

with open('salmalm/engine.py', 'r') as f:
    content = f.read()
...
new_content = content[:insert_point] + handler_code + content[insert_point:]

with open('salmalm/engine.py', 'w') as f:
    f.write(new_content)
print('OK: inserted handler functions')
