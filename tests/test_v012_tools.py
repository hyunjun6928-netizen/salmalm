...
class TestReminderTool(unittest.TestCase):
    ...
    def setUp(self):
        from salmalm.tools.tool_handlers import _reminders, _reminder_lock
        with _reminder_lock:
            _reminders.clear()
    ...
    def test_delete_reminder(self):
        from salmalm.tools.tool_handlers import execute_tool, _reminders
...
class TestWorkflowTool(unittest.TestCase):
    ...
    def test_save_and_list(self):
        from salmalm.tools.tool_handlers import execute_tool, _workflows_file
